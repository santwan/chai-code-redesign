...
const HeroSection = () => {
  return (
    ...
    >
      ...
      {/* Main Heading */}
      <motion.h1 variants={fadeUp} className="max-w-full text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-300 transition-all duration-1000 ease-out transform hover:scale-105 hover:brightness-110">
