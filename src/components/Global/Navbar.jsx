          ...
          >
            {navConfig.map(({ label, href, isLive }) => (
              <a
                key={label}
                href={href}
                className="lg:text-xl relative flex items-center px-4 py-2 rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_15px_4px_rgba(255,115,0,0.6)]"
              >
